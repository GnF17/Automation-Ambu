...
void telaLcd(float x){ //Funcao LCD - x eh o valor da frequencia
  ...
  lcd.setCursor(12,1);
  lcd.print("      ");//Limpar todos os digitos impressos
  lcd.setCursor(12,1);
...
void motorFuncao(){ //Funcao motor
  ...
  frequencia = (potenciometro/3.2428571429); //Converte o valor lido em um valor de frequencia
